...
const CitiesCard = memo(({ index, data, cardClicked }) => {
  ...
  return (
    <div className='text-left text-xs px-4 pb-4 bg-gradient-to-r from-neutral-700 to-transparent rounded-lg shadow-lg hover:cursor-pointer hover:scale-105 transition-transform duration-150' onClick={handleClick}>
